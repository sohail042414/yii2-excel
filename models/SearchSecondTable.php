...
/**
 * SearchSecondTable represents the model behind the search form of `app\models\SecondTable`.
 */
class SearchSecondTable extends SecondTable
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['field_1', 'field_2', 'field_3', 'field_4', 'field_5', 'field_6', 'field_7', 'field_8', 'field_9', 'field_10'], 'safe'],
        ];
    }
